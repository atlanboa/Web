...
<h4>${user} 님 로그인 되었습니다. <a href="${pageContext.request.contextPath}/member.do?command=LOGOUT">로그아웃</a></h4>
</c:if>
<!--도서정보입력 FORM 테이블시작//-->
<FORM METHOD="post" action="${pageContext.request.contextPath}/book.do?command=registerBook" name="bookForm" id="bookForm">
